import { themes, borderStyles } from './chunk-DAJV34EK.js';
export { borderStyles, colors, themes } from './chunk-DAJV34EK.js';
import { Text as Text$1, Box as Box$1, useInput } from 'ink';
import React10, { createContext, memo, useState, useEffect, useContext, useCallback, useMemo, useRef, useReducer } from 'react';
import { jsxs, jsx } from 'react/jsx-runtime';

var CaretContext = createContext(void 0);
var CaretProvider = ({ children, initialTheme = "shadcn" }) => {
  ...
  return /* @__PURE__ */ jsx(CaretContext.Provider, { value, children });
};
var useCaret = () => {
...
var Box = ({
  ...
  const currentBorderStyle = borderStyle ? borderStyles[borderStyle] : void 0;
...
var Text = ({
  ...
  return /* @__PURE__ */ jsx(Text$1, { ...props, color: textColor, children });
};
var Card = ({
  title,
  footer,
  ...
  return /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      width: "100%",
      children: [
        title && /* @__PURE__ */ jsx(Box, { marginTop: -1, paddingX: 1, backgroundColor: theme.background, children: /* @__PURE__ */ jsx(Text, { bold: true, variant: variant === "default" ? "primary" : variant, children: ` ${title.toUpperCase()} ` }) }),
        /* @__PURE__ */ jsx(Box, { paddingY: 1, flexDirection: "column", width: "100%", children }),
        footer && /* @__PURE__ */ jsx(Box, { marginBottom: -1, paddingX: 1, backgroundColor: theme.background, alignSelf: "flex-end", children: /* @__PURE__ */ jsx(Text, { dimColor: true, italic: true, variant: "muted", children: ` ${footer} ` }) })
      ]
    }
  );
};
var Badge = ({
  ...
  if (variant === "outline") {
    return /* @__PURE__ */ jsx(Box, { borderStyle: "single", paddingX: 1, borderColor: theme.border, children: /* @__PURE__ */ jsx(Text, { variant: "muted", children: label }) });
  }
  ...
  return /* @__PURE__ */ jsx(Box, { backgroundColor: bgColor, children: /* @__PURE__ */ jsx(Text, { bold: true, color: isLight ? "black" : "white", backgroundColor: bgColor, children: paddedLabel }) });
};
var spinners = {
  // --- Tes Classiques ---
  dots: ["\u280B", "\u2819", "\u2839", "\u2838", "\u283C", "\u2834", "\u2826", "\u2827", "\u2807", "\u280F"],
...
var SpinnerInner = ({
  ...
  return /* @__PURE__ */ jsxs(Text, { children: [
    /* @__PURE__ */ jsx(Text, { variant: variant === "default" ? "primary" : variant, bold: true, children: frames[frame] }),
    label && /* @__PURE__ */ jsxs(Text, { variant: "muted", children: [
      " ",
      label
    ] })
  ] });
};
var Spinner = memo(SpinnerInner);
...
var ProgressBar = ({
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", width: "100%", children: [
    label && /* @__PURE__ */ jsx(Box, { marginBottom: 0, children: /* @__PURE__ */ jsx(Text, { dimColor: true, children: label }) }),
    /* @__PURE__ */ jsxs(Box, { flexDirection: "row", width: "100%", flexWrap: "nowrap", children: [
      /* @__PURE__ */ jsx(Text, { variant, children: filled }),
      /* @__PURE__ */ jsx(Text, { variant: "muted", children: empty }),
      showValue && /* @__PURE__ */ jsxs(Text, { children: [
        " ",
        Math.round(progress),
        "%"
      ] })
...
function Select({
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", children: [
    label && /* @__PURE__ */ jsx(Box, { marginBottom: 1, children: /* @__PURE__ */ jsx(Text, { bold: true, variant: "primary", children: label.toUpperCase() }) }),
    /* @__PURE__ */ jsxs(Box, { flexDirection: "column", borderStyle: "single", borderColor: theme.border, paddingX: 1, children: [
      hasMoreAbove && /* @__PURE__ */ jsx(Box, { justifyContent: "center", children: /* @__PURE__ */ jsxs(Text, { color: theme.muted, children: [
        "\u25B2 ",
        state.viewportStart,
        " more"
      ] }) }),
      visibleOptions.map((option, i) => {
        ...
        return /* @__PURE__ */ jsxs(Box, { gap: 1, flexDirection: "column", children: [
          /* @__PURE__ */ jsxs(Box, { gap: 1, children: [
            /* @__PURE__ */ jsx(Text, { color: isFocused ? theme.primary : theme.muted, children: isFocused ? ">" : " " }),
            /* @__PURE__ */ jsx(
              Text,
              {
                bold: isFocused,
          ...
          option.description && isFocused && /* @__PURE__ */ jsx(Box, { paddingLeft: 4, children: /* @__PURE__ */ jsx(Text, { color: theme.muted, children: option.description }) })
        ] }, String(option.value));
      }),
      hasMoreBelow && /* @__PURE__ */ jsx(Box, { justifyContent: "center", children: /* @__PURE__ */ jsxs(Text, { color: theme.muted, children: [
        "\u25BC ",
        options.length - state.viewportStart - effectiveVisible,
        " more"
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(Box, { marginTop: 0, paddingX: 1, children: /* @__PURE__ */ jsxs(Text, { dimColor: true, children: [
...
var FocusProvider = ({ children }) => {
  ...
  const releaseFocus = useCallback((id) => {
    if (focusedRef.current === id) {
      focusedRef.current = null;
      setFocusedId(null);
    }
  }, []);
  const isFocused = useCallback((id) => {
    return focusedRef.current === id;
  }, []);
  return /* @__PURE__ */ jsx(FocusContext.Provider, { value: { focusedId, requestFocus, releaseFocus, isFocused }, children });
};
var useFocus = () => {
...
function ScrollableList({
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "row", width: "100%", children: [
    /* @__PURE__ */ jsx(Box, { flexDirection: "column", flexGrow: 1, children: visibleItems.map((item, i) => {
      ...
      return /* @__PURE__ */ jsxs(
        Box,
        {
          ...
          width: "100%",
          children: [
            /* @__PURE__ */ jsx(Box, { marginRight: 1, children: /* @__PURE__ */ jsx(Text, { color: isSelected ? theme.primary : theme.muted, children: isSelected ? ">" : " " }) }),
            /* @__PURE__ */ jsx(Box, { flexGrow: 1, children: renderItem(item, isSelected) })
          ]
        },
        absoluteIndex
      );
    }) }),
    scrollbarInfo && /* @__PURE__ */ jsx(Box, { flexDirection: "column", width: 1, marginLeft: 1, children: Array.from({ length: height }).map((_, i) => {
      const isThumb = i >= scrollbarInfo.thumbPos && i < scrollbarInfo.thumbPos + scrollbarInfo.thumbSize;
      return /* @__PURE__ */ jsx(Text, { color: isThumb ? theme.secondary : theme.muted, children: isThumb ? "\u2588" : "\u2502" }, i);
    }) })
  ] });
}
...
var FileTree = ({
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", children: [
    hasAbove && /* @__PURE__ */ jsxs(Text, { color: theme.muted, children: [
      "  \u25B2 ",
      state.viewportStart,
      " more"
    ] }),
    visible.map((flat, i) => {
      ...
      return /* @__PURE__ */ jsxs(Box, { children: [
        /* @__PURE__ */ jsx(Text, { color: isFocused ? theme.primary : theme.muted, children: isFocused ? ">" : " " }),
        /* @__PURE__ */ jsxs(Text, { color: isFocused ? theme.foreground : theme.muted, children: [
          indent,
          prefix
        ] }),
        /* @__PURE__ */ jsx(
    ...
    hasBelow && /* @__PURE__ */ jsxs(Text, { color: theme.muted, children: [
      "  \u25BC ",
      flatNodes.length - state.viewportStart - effective,
      " more"
    ] }),
    flatNodes.length > 0 && /* @__PURE__ */ jsx(Box, { marginTop: 0, paddingX: 1, children: /* @__PURE__ */ jsx(Text, { dimColor: true, children: "\u2191\u2193 navigate \xB7 \u2190\u2192/Space expand \xB7 Enter select" }) })
  ] });
};
function DataTable({
  id = "data-table",
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", width: "100%", children: [
    /* @__PURE__ */ jsx(Box, { paddingX: 1, marginBottom: 0, children: columns.map((col) => /* @__PURE__ */ jsx(Box, { width: col.width || 15, marginRight: 2, children: /* @__PURE__ */ jsxs(Text, { bold: true, color: sortKey === col.key ? theme.primary : theme.muted, children: [
      col.header.toUpperCase(),
      sortKey === col.key && (sortOrder === "asc" ? " \u25B2" : " \u25BC")
    ] }) }, String(col.key))) }),
    /* @__PURE__ */ jsx(Box, { width: "100%", height: 1, children: /* @__PURE__ */ jsx(Text, { color: theme.border, children: "\u2500".repeat((process.stdout.columns ?? 80) - 10) }) }),
    /* @__PURE__ */ jsx(Box, { flexDirection: "column", width: "100%", children: paginatedData.map((item, rowIndex) => {
      const isEvenRow = rowIndex % 2 === 0;
      const bgColor = isEvenRow ? theme.border : void 0;
      return /* @__PURE__ */ jsxs(Box, { paddingX: 1, backgroundColor: bgColor, width: "100%", children: [
        columns.map((col) => /* @__PURE__ */ jsx(Box, { width: col.width || 15, marginRight: 2, children: col.render ? /* @__PURE__ */ jsx(Box, { backgroundColor: bgColor, width: "100%", children: col.render(item[col.key], item) }) : /* @__PURE__ */ jsx(Text, { backgroundColor: bgColor, color: isEvenRow ? theme.foreground : theme.muted, children: padText(String(item[col.key]), col.width || 15, col.align) }) }, String(col.key))),
        /* @__PURE__ */ jsx(Box, { flexGrow: 1, backgroundColor: bgColor, children: /* @__PURE__ */ jsx(Text, { children: " " }) })
      ] }, rowIndex);
    }) }),
    /* @__PURE__ */ jsxs(Box, { marginTop: 1, paddingX: 1, justifyContent: "space-between", width: "100%", children: [
      /* @__PURE__ */ jsxs(Box, { gap: 1, children: [
        /* @__PURE__ */ jsxs(Text, { variant: "muted", children: [
          "Page ",
          currentPage + 1,
          " of ",
          totalPages
        ] }),
        focused && /* @__PURE__ */ jsx(Text, { color: theme.primary, children: "[Use \u2190/\u2192 to navigate \u2022 's' to sort]" })
      ] }),
      /* @__PURE__ */ jsxs(Text, { variant: "muted", children: [
        "Total items: ",
        data.length
...
var CommandInput = ({
  ...
  const renderContent = () => {
    if (value === "" && focused) {
      return /* @__PURE__ */ jsxs(Box, { children: [
        /* @__PURE__ */ jsx(Text, { backgroundColor: cursorVisible ? theme.active : "transparent", color: "black", children: " " }),
        /* @__PURE__ */ jsx(Text, { variant: "muted", children: placeholder })
      ] });
    }
    if (!focused) return /* @__PURE__ */ jsx(Text, { variant: "muted", children: value === "" ? placeholder : renderText(value) });
    const beforeCursor = value.slice(0, cursorPosition);
    const atCursor = value[cursorPosition] || " ";
    const afterCursor = value.slice(cursorPosition + 1);
    return /* @__PURE__ */ jsxs(Box, { children: [
      /* @__PURE__ */ jsx(Text, { children: renderText(beforeCursor) }),
      /* @__PURE__ */ jsx(Text, { backgroundColor: cursorVisible ? theme.active : "transparent", color: "black", children: type === "password" && atCursor !== " " ? "*" : atCursor }),
      /* @__PURE__ */ jsx(Text, { children: renderText(afterCursor) }),
      /* @__PURE__ */ jsx(Text, { color: theme.muted, children: ghostText })
    ] });
  };
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", width: "100%", children: [
    /* @__PURE__ */ jsx(Box, { width: "100%", height: 1, marginBottom: 0, children: /* @__PURE__ */ jsx(Text, { color: theme.border, children: "\u2500".repeat((process.stdout.columns ?? 80) - 8) }) }),
    /* @__PURE__ */ jsxs(Box, { paddingX: 1, gap: 1, children: [
      /* @__PURE__ */ jsx(Text, { bold: true, color: focused ? theme[variant] : theme.muted, children: prefix }),
...
var Sparkline = ({
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", children: [
    label && /* @__PURE__ */ jsx(Text, { variant: "muted", children: label.toUpperCase() }),
    /* @__PURE__ */ jsxs(Box, { gap: 0, children: [
      history.map((v, i) => /* @__PURE__ */ jsx(Text, { variant, children: renderBar(v) }, i)),
      history.length < width && /* @__PURE__ */ jsx(Text, { variant: "muted", children: " ".repeat(width - history.length) })
    ] })
  ] });
};
    ...
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        Box,
        {
          ...
          height,
          children: [
            /* @__PURE__ */ jsx(Box, { position: "absolute", flexDirection: "column", width: width - 2, height: height - 2, children: Array.from({ length: height - 2 }).map((_, i) => /* @__PURE__ */ jsx(Text, { backgroundColor: theme.background, children: " ".repeat(width - 2) }, i)) }),
            /* @__PURE__ */ jsx(Box, { flexDirection: "column", paddingX: 2, paddingY: 1, width: "100%", height: "100%", children })
          ]
        }
      )
    }
...
var Pane = ({
  ...
  return /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      children: [
        title && /* @__PURE__ */ jsx(Box, { marginTop: -1, paddingX: 1, backgroundColor: theme.background, children: /* @__PURE__ */ jsx(Text, { bold: true, color: theme.secondary, children: ` ${title.toUpperCase()} ` }) }),
        /* @__PURE__ */ jsx(Box, { flexDirection: "column", flexGrow: 1, width: "100%", children })
      ]
    }
  );
};
var Markdown = ({ children }) => {
  ...
  const renderTextWithLinks = (text) => {
    ...
    return parts.map((part, i) => {
      ...
      if (linkMatch) {
        return /* @__PURE__ */ jsx(Text, { color: theme.secondary, underline: true, children: linkMatch[1] }, i);
      }
      const boldParts = part.split(/(\*\*.*?\*\*)/g);
      return boldParts.map((bp, bi) => {
        if (bp.startsWith("**") && bp.endsWith("**")) {
          return /* @__PURE__ */ jsx(Text, { bold: true, children: bp.replace(/\*\*/g, "") }, bi);
        }
        return /* @__PURE__ */ jsx(Text, { children: bp }, bi);
      });
    });
  };
  return /* @__PURE__ */ jsx(Box, { flexDirection: "column", children: lines.map((line, i) => {
    if (line.startsWith("# ")) {
      return /* @__PURE__ */ jsx(Box, { marginBottom: 1, children: /* @__PURE__ */ jsx(Text, { bold: true, color: theme.primary, underline: true, children: line.replace("# ", "").toUpperCase() }) }, i);
    }
    if (line.startsWith("|") && line.endsWith("|")) {
      const cells = line.split("|").filter((c) => c.trim() !== "");
      if (cells.every((c) => c.trim().startsWith("-"))) return null;
      return /* @__PURE__ */ jsx(Box, { gap: 2, children: cells.map((cell, ci) => /* @__PURE__ */ jsx(Box, { width: 15, children: /* @__PURE__ */ jsx(Text, { children: cell.trim() }) }, ci)) }, i);
    }
    if (line.startsWith("- ")) {
      return /* @__PURE__ */ jsxs(Box, { paddingLeft: 2, children: [
        /* @__PURE__ */ jsx(Text, { color: theme.primary, children: "\u25CF " }),
        /* @__PURE__ */ jsx(Box, { flexGrow: 1, children: /* @__PURE__ */ jsx(Text, { children: renderTextWithLinks(line.replace("- ", "")) }) })
      ] }, i);
    }
    if (line.startsWith("`") && line.endsWith("`")) {
      return /* @__PURE__ */ jsx(Box, { backgroundColor: theme.border, paddingX: 1, children: /* @__PURE__ */ jsx(Text, { color: theme.secondary, children: line.replace(/`/g, "") }) }, i);
    }
    return /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(Text, { children: renderTextWithLinks(line) }) }, i);
  }) });
};
var StepWizard = ({ steps, onComplete, isActive = true }) => {
  ...
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", gap: 1, children: [
    /* @__PURE__ */ jsx(Box, { gap: 2, marginBottom: 1, children: steps.map((step, i) => /* @__PURE__ */ jsxs(Box, { gap: 1, children: [
      /* @__PURE__ */ jsx(Badge, { variant: i === currentStep ? "primary" : i < currentStep ? "success" : "secondary", children: `${i + 1}` }),
      /* @__PURE__ */ jsx(Text, { bold: i === currentStep, color: i === currentStep ? "white" : void 0, children: step.title }),
      i < steps.length - 1 && /* @__PURE__ */ jsx(Text, { variant: "muted", children: "\u2192" })
    ] }, i)) }),
    /* @__PURE__ */ jsx(Box, { borderStyle: "single", borderColor: "#262626", padding: 1, minHeight: 6, children: steps[currentStep].content }),
    /* @__PURE__ */ jsxs(Box, { gap: 2, marginTop: 1, children: [
      currentStep > 0 && /* @__PURE__ */ jsxs(Box, { gap: 1, children: [
        /* @__PURE__ */ jsx(Text, { bold: true, color: "white", children: "[P]" }),
        /* @__PURE__ */ jsx(Text, { variant: "muted", children: "Previous" })
      ] }),
      /* @__PURE__ */ jsxs(Box, { gap: 1, children: [
        /* @__PURE__ */ jsx(Text, { bold: true, color: "white", children: "[N]" }),
        /* @__PURE__ */ jsx(Text, { variant: "muted", children: currentStep === steps.length - 1 ? "Finish" : "Next" })
      ] })
    ] })
  ] });
};
var SearchModal = ({
  ...
  const width = 54;
  return /* @__PURE__ */ jsx(Overlay, { isOpen, children: /* @__PURE__ */ jsxs(Box, { flexDirection: "column", width, children: [
    /* @__PURE__ */ jsxs(Box, { gap: 1, marginBottom: 1, children: [
      /* @__PURE__ */ jsx(Text, { bold: true, color: "white", children: "SEARCH:" }),
      /* @__PURE__ */ jsx(Text, { color: "white", children: query }),
      query === "" && /* @__PURE__ */ jsx(Text, { color: "#404040", children: placeholder })
    ] }),
    /* @__PURE__ */ jsx(Box, { width: "100%", height: 1, marginBottom: 1, children: /* @__PURE__ */ jsx(Text, { color: "#404040", children: "\u2500".repeat(width) }) }),
    /* @__PURE__ */ jsx(Box, { flexDirection: "column", children: filteredItems.map((item, i) => {
    ...
    /* @__PURE__ */ jsx(Box, { marginTop: 1, justifyContent: "center", width: "100%", children: /* @__PURE__ */ jsx(Text, { color: "#404040", children: "\u2191\u2193 NAVIGATE \xB7 ENTER SELECT \xB7 ESC CLOSE" }) })
  ] }) });
};
...
var NotificationProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs(NotificationContext.Provider, { value: { notify }, children: [
    /* @__PURE__ */ jsx(Box, { flexDirection: "column", width: "100%", children }),
    /* @__PURE__ */ jsx(
      Box,
      {
        position: "absolute",
        ...
        children: visible.map((n) => {
          ...
          return /* @__PURE__ */ jsx(Box, { marginTop: 1, borderStyle: "single", borderColor: color, padding: 0, children: /* @__PURE__ */ jsx(Text, { backgroundColor: theme.border, color, bold: true, children: paddedText }) }, n.id);
        })
      }
    )
  ] });
...
export { Badge, Box, Card, CaretProvider, CommandInput, DataTable, FileTree, FocusProvider, Markdown, NotificationProvider, Overlay, Pane, ProgressBar, ScrollableList, SearchModal, Select, Separator, Sparkline, Spinner, StepWizard, Text, useCaret, useFocus, useKeyboard, useNotify };
